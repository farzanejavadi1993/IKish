...
class CustomSnackbar(private val context: Context) {
    ...
    private fun makeSnackbar(view: View) {
     ...
     /*   val params = ActionBar.LayoutParams(
        ...
        params.setMargins(22, 0, 22, 80)*/
       val view1 =
            snackbar.view.findViewById<View>(R.id.snackbar_text) as TextView
       // view1.setTypeface(PassengerListFragment.typeFace)
       // view1.setTextSize(TypedValue.COMPLEX_UNIT_SP, context.resources.getDimension(R.dimen.snackbar_textsize))
       ...
       // snackbar.view.layoutParams=params
        ...
        val snackContentLayout = snackbarLayout.getChildAt(0) as SnackbarContentLayout // Linear Layout
           ...
           // view1.setTypeface(ResourcesCompat.getFont(context, R.font.fonts))
