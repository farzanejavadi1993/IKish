package ikish.aftab.ws.android.classes;
...
import ikish.aftab.ws.android.classes.util.PersianCalendar;
import ikish.aftab.ws.android.classes.util.PersianCalendarConstants;
import ikish.aftab.ws.android.classes.util.PersianCalendarUtils;
...
public class PersianDatePicker extends LinearLayout {
    ...
    public PersianDatePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (type.equals("2")){
            yearNumberPicker.setVisibility(GONE);
            monthNumberPicker.setVisibility(GONE);

        }else {
            yearNumberPicker.setVisibility(VISIBLE);
            monthNumberPicker.setVisibility(VISIBLE);

        }

        try {
            dayNumberPicker.setTypeface((ResourcesCompat.getFont(context, R.font.iransans)));
            dayNumberPicker.setSelectedTypeface((ResourcesCompat.getFont(context, R.font.iransans)));
            yearNumberPicker.setTypeface((ResourcesCompat.getFont(context, R.font.iransans)));
            yearNumberPicker.setSelectedTypeface((ResourcesCompat.getFont(context, R.font.iransans)));
        }catch (Exception e){}
        ...
        yearNumberPicker.setOnValueChangedListener(date);
        ...
        monthNumberPicker.setOnValueChangedListener(date);
        ...
        dayNumberPicker.setOnValueChangedListener(date);
...
//    };
    ...
    com.shawnlin.numberpicker.NumberPicker.OnValueChangeListener date = new com.shawnlin.numberpicker.NumberPicker.OnValueChangeListener() {
        @Override
